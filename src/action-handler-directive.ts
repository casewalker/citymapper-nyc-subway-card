...
customElements.define('action-handler-nyc-citymapper-subway', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-nyc-citymapper-subway')) {
    return body.querySelector('action-handler-nyc-citymapper-subway') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-nyc-citymapper-subway');
